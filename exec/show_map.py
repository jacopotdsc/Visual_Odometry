...
def plot_landmarks(gt_file, est_file, frequency=1.0):
...
if __name__ == "__main__":
    ...
    parser.add_argument('frequency', type=float, help="Fraction of landmarks to plot (0 < freq <= 1)")
    ...
    plot_landmarks(args.gt_file, args.est_file, frequency=args.frequency)
